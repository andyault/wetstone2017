...
function wetstone_post_customer_registration() {
	...
	if(!is_wp_error($id)) {
		...
		$message .= " "."\n\nThis portal is where you will have access to the following:\n • Account information\n • Product downloads\n • License Keys\n • FAQ's\n • Dataset updates\n • Connectivity to customer support\n\nOnce you gain access to the portal we encourage you to click on the product(s) you have purchased and navigate to the User Guide tab where you will find the product user guide to help you with installation.\n\nPlease visit our video library at https://video.wetstonetech.com/video-categories/wetstone-solutions/ to view demonstrations and how-to videos for your WetStone products. \n\nAlso, please note that if you have token-based products that use an encrypted token you will need to use the password provided to you for the device. Too many incorrect password attempts will result in a non-functioning token. If you have further questions, please contact your Account Executive or our support department directly at support@wetstonetech.com.\n\nSincerely,\nThe WetStone Team";
		wp_mail(
			$user['user_email'],
