...
function display_GDS($atr){
	ob_start();
		...
		$aca_table .= '<td style="padding-left:7px; width:475px; height:25px;"><a href="https://www.wetstonetech.com/product-dl.php?file='.urlencode($hashes.'/'.$hashFiles[0]).'" target="_blank" style="text-decoration:none; color:green;">Hash File</a><br /><span style="font-size:12px; margin-top:-10px;">MD5 - '. md5_file('https://www.wetstonetech.com/product-dl.php?file='.urlencode($hashes.'/'.$hashFiles[0])).'</span></td><td><img src="https://www.wetstonetech.com/wp-content/uploads/2017/11/zip-icon.png" /></td>';
		$aca_table .= '</tr>';
		$aca_table .= '</table>';
