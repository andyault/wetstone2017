			...
			<div class="site-footer-inner site-content site-content-padded">
				<?php
					function footer_link($page, $depth) {
						...
						if($page->ID >= 612 && $page->ID <= 634 || $page->ID == 1054 || $page->ID == 116 || $page->ID == 1815 || $page->ID == 1667 || $page->ID == 1807 || $page->ID == 2455 || $page->ID == 2439 ) { // IDs of unwanted product in Footer
						 if ($page->ID == 633) {
