			...
			<div class="site-footer-inner site-content site-content-padded">
				<?php
					function footer_link($page, $depth) {
						...
						if($page->ID >= 612 && $page->ID <= 634 || $page->ID == 1054 || $page->ID == 116 || $page->ID == 1815 || $page->ID == 1667 || $page->ID == 1807) { // IDs of unwanted product in Footer
						 if ($page->ID == 633) {
					...
					//sgo
					footer_list(['home', 'about-us', 'contact', 'news','partners-resellers']);
					footer_list(['products']);
					footer_list(['video-library', 'services']); 
