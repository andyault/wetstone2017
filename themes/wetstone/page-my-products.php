				...
				<?php
					if($products) {
						foreach($products as $id => $info) {
							...
							if ($days_between <= 90) {
								echo "<span style='color:red'> - Your license expires in <strong>\"". $days_between . " day(s)\"</strong>. To renew, please contact <a href=\"mailto:sales@wetstonetech.com\" class=\"link link-body\">sales@wetstonetech.com</a>."; 
								}
