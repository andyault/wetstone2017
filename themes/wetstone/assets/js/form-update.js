function country_update() {
	...
	var notUSStates = 'State/Province:<br /><input type="text" name="state" placeholder="MD" class="form-input" size="7">';		
			
	var inUSPhone = '<i class="req">*</i> Phone:<input id="phoneVal" type="tel" name="phone" placeholder="+1 (555) 867-5309" class="form-input" required onfocusout="validateUSPhone();">';
...
function validateEmail() {
	...
	if (!email1 || email1 == "" || !email2 || email2 =="") {
		 ...
		 document.getElementById("emailCH").innerHTML = "<span style=\"color:green;\">&#x2714;</span>";
	 } else {
