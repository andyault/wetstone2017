<div class="product-preview-slide" style="background: <?php echo get_post_meta($post->ID, 'product_color', true); ?>">
	...
	<div class="product-preview-inner site-content">
		...
		<div class="product-preview-info">
			...
			<a class="product-preview-button link link-button">Go to product page</a>
		</div>
	</div>
</div>