...
<?php
	...
	switch($context) {
		...
		default:
			$subjectVal = ($subject ? '%s' : 'SAIS Contact Form');
...
<form name="saiscontact" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="form">
	<input type="hidden" name="action" value="wetstone-sais-contact">
	<?php wp_nonce_field('wetstone-sais-contact'); ?>
	...
	<table class="form-table form-table-collapse">
		...
		<tr>
			...
			<td><?php echo wetstone_form_make_input('jobtitle', 'text', 'Job Title/Position', 'Investigator', false); ?></td>
		</tr>
		...
		<tr>
			...
			<td>
				<?php
					echo wetstone_form_make_checkboxes(
						'products[]',
						'Please select your product of interest:',
						$products,
						true
					);
				?>
			...
			<?php
				$interests = [
					...
					'To evaluate a product(s)',
					'A quote for the selected product(s)',
					'Other (please specify in comments)'
				];
			?>
			...
			<td>
				...
				?>
				<p style="margin:15px 0px 0px 0px">NOTE: Evaluation licenses are provided to demonstrate the capabilities of WetStone products. Some scanning and reporting features will be limited. </p>
			</td>
		...
		<tr>
			<td colspan="2" class="table-footer">
				<div class="inline-flex">				
					<p>By selecting Submit, you agree that WetStone Technologies may use the provided information to contact you about services or products that WetStone may offer. WetStone Technologies will not share your information with third-parties or advertisers.</p>
				</div>
			</td>
		</tr>
