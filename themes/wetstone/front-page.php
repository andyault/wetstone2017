...
<section class="hero fullpage fullpage-hero">
	...
	<div class="hero-info">
		...
		<p class="hero-desc" style="font-size: 18px; margin:50px 0px 0px 0px">Our NEW Multi-Platform Malware Discovery Tool<br />Gargoyle Investigator(TM) MP<br />Coming Soon!</p>
	</div>
